...
<body>
	<div class="header">
		...
		<ul class="inline">
			<li>
				<img src="${pageContext.request.contextPath}/images/32/client.png" />&nbsp;&nbsp;欢迎您,${sUser.username}   
			</li>
			<li class="dropdown">
			...
			<li><img
				src="${pageContext.request.contextPath}/images/32/200.png" />&nbsp;&nbsp;<a
				class="loginout" href="#">退出</a></li>
		</ul>
	</div>
	...
	<div class="nav">
		<ul class="breadcrumb">
			<li><img
				src="${pageContext.request.contextPath}/images/32/5025_networking.png" />
			</li>
	...
	<div class="container-fluid content">
		<div class="row-fluid">
			<div class="span2 content-left">
				<div class="accordion">
					<div class="accordion-group">
						...
						<div id="collapseOne" class="accordion-body collapse in">
							<div class="accordion-inner">
								<img    class="left-icon-child" src="${pageContext.request.contextPath}/images/32/4957_customers.png" />
								<span class="left-body">
								<a  href="list.action"  target="left_">客户管理</a>
								</span>
							</div>
						</div>
					</div>
			...
			<div class="span10 content-right">
				<iframe name="left_"   src="${pageContext.request.contextPath}/scust/custList.action"
					class="iframe"></iframe>
			</div>
		</div>
	</div>
